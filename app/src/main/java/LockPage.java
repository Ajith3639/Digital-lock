...
public class LockPage extends Activity {
    ...
    Button lock_state_btn, unlock_btn;
    ...
    private static String address = "B4:4B:0E:04:2D:18";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lock_image=findViewById(R.id.lock_state_img);
...
// for display the received data from the Arduino
                ...
                switch (msg.what) {
                    case RECIEVE_MESSAGE:                                                   // if receive massage
                        ...
                        if (endOfLineIndex > 0) {                                            // if end-of-line,
                            ...
                            lock_state_text.setText("Data from Arduino: " + sbprint);            // update TextView
                            lock_state_btn.setEnabled(true);
        ...
        lock_state_btn.setOnClickListener(new OnClickListener() {
